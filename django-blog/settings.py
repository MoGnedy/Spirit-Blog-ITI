...
# TEMPLATES[0]['OPTIONS']['context_processors'].append("blog.context_processors.show_category2")
# TEMPLATE_CONTEXT_PROCESSORS = ("blog.context_processors.show_category2", )
TEMPLATE_CONTEXT_PROCESSORS = ('blog.context_processors.show_category',)